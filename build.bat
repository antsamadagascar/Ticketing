...
set "root=C:\Program Files\Apache Software Foundation\Tomcat 10.1\webapps\Ticketing"
set "target_dir=C:\Program Files\Apache Software Foundation\Tomcat 10.1\webapps\Ticketing\lib"
set "config_target_dir=C:\Program Files\Apache Software Foundation\Tomcat 10.1\webapps\Ticketing\web\WEB-INF\classes\config"

set "temp=%root%\temp"
set "src=%root%\src"
set "lib=%root%\lib"
set "bin=%root%\bin"
set "jar_name=ticketing"
...
start "" "http://localhost:8081/Ticketing/"
