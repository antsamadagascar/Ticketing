            ...
            <div class="offcanvas-body">
                ...
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('recherche*') ? 'active' : '' }}" href="${pageContext.request.contextPath}/recherche">
                        ...
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/reservation-vol" class="nav-link {{ request()->is('promotions*') ? 'active' : '' }}">
                                <i class="fas fa-tags"></i> Reserver
                            </a>
                            <a href="${pageContext.request.contextPath}/mes-reservation" class="nav-link {{ request()->is('regles-reservation*') ? 'active' : '' }}">
                                <i class="fas fa-calendar-check"></i> Mes Vol
                            </a>
                        </li>
                    </ul>
                </div>
